...
#' @name plot.CPO
#' @param x an object of class \code{getEstimator} with \code{estimator="CPO"}
...
#' }
#' @export
plot.CPO <- function(x, outlier.mark=TRUE, outlier.thresh=0.01, scale.CPO=TRUE, x.loc=FALSE, axis.label=NULL, las=0, cex.axis=1, mark.pos=c(0,-.01), mark.color=2, mark.cex=0.8,
